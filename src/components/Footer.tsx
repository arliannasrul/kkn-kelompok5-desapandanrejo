      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/kknpandanrejo5" target="_blank" className="p-3 bg-white/10 hover:bg-secondary hover:text-primary transition-colors rounded-full" title="Instagram"><Instagram className="w-5 h-5" /></a>
              <a href="https://tiktok.com/@kknunmerkelompok5" target="_blank" className="p-3 bg-white/10 hover:bg-secondary hover:text-primary transition-colors rounded-full" title="TikTok"><Camera className="w-5 h-5" /></a>
              <a href="mailto:almer.rasyid@unmer.ac.id" className="p-3 bg-white/10 hover:bg-secondary hover:text-primary transition-colors rounded-full" title="Email"><Mail className="w-5 h-5" /></a>
              <a href="tel:087849776598" className="p-3 bg-white/10 hover:bg-secondary hover:text-primary transition-colors rounded-full" title="WhatsApp"><Phone className="w-5 h-5" /></a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-white/40 text-sm">
          ...
          <div className="flex gap-8">
            <span className="text-secondary/60 italic">19 Jan - 19 Feb 2026</span>
          </div>
        </div>
      </div>
    </footer>
